...
THREE.LoaderSupport.PrepData.prototype = {
	...
	/**
	 * Clones this obj and returns it afterwards. Callbacks and resources are not cloned deep (references!).
	 *
...
THREE.LoaderSupport.MeshBuilder.prototype = {
	...
	/**
	 * Returns the mapping obj of material name and corresponding jsonified material.
	 *
	...
	/**
	 * Returns the mapping obj of material name and corresponding material.
	 *
...
THREE.LoaderSupport.WorkerSupport.prototype = {
	 ...
	 * @param {String} parserName Name of the Parser obj
...
THREE.LoaderSupport.WorkerRunnerRefImpl.prototype = {
	...
	/**
	 * Applies values from parameter obj via set functions or via direct assignment.
	 *
	 * @param {Object} parser The parser instance
	 * @param {Object} params The parameter obj
	 */
	...
	/**
	 * Configures the Parser implementation according the supplied configuration obj.
	 *
	 * @param {Object} payload Raw mesh description (buffers, params, materials) used to build one to many meshes.
	 */
...
THREE.LoaderSupport.NodeWorkerRunnerRefImpl = function () {
	...
	// Also, the message obj can be passed directly to
	// processMessage() as it isn't an `Event`, but a plain obj
	// with the data
